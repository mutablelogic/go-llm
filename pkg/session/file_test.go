...
func Test_file_012(t *testing.T) {
	...
	dir := t.TempDir()
	store, _ := session.NewFileStore(dir)
	store.Create(context.TODO(), schema.SessionMeta{Name: "real", Model: "test-model", Provider: "test-provider"})
	// Create junk files
...
func Test_file_013(t *testing.T) {
	...
	dir := t.TempDir()
	store, _ := session.NewFileStore(dir)
	store.Create(context.TODO(), schema.SessionMeta{Name: "good", Model: "test-model", Provider: "test-provider"})
...
func Test_file_015(t *testing.T) {
	...
	dir := t.TempDir()
	store, _ := session.NewFileStore(dir)
	s, _ := store.Create(context.TODO(), schema.SessionMeta{Name: "round-trip", Model: "test-model", Provider: "test-provider"})
...
func Test_file_016(t *testing.T) {
	...
	dir := t.TempDir()
	store, _ := session.NewFileStore(dir)
	s1, _ := store.Create(context.TODO(), schema.SessionMeta{Name: "a", Model: "test-model", Provider: "test-provider"})
	s2, _ := store.Create(context.TODO(), schema.SessionMeta{Name: "b", Model: "test-model", Provider: "test-provider"})
